...
- (IBAction)showOnMap
{
	NSURL *myURL = [NSURL URLWithString:[[NSString stringWithFormat:@"http://maps.google.com/maps?q=%@ %@, %@", [self.store valueForKey:@"addLine1"], [self.store valueForKey:@"addLine2"], [self.store valueForKey:@"Country"]] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
